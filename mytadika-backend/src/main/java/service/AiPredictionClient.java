...
public class AiPredictionClient {
    ...
    /**
     * Calls FastAPI microservice. Falls back to deterministic heuristic if FastAPI is offline.
     */
    public PredictionResponse predict(String childId, double ageMonths, double weightKg, double heightCm, Double muacCm, String gender) {
